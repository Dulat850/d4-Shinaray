...
public class Admin_Can extends Admin {
    ...
    private boolean getAllCars = true;
    private boolean getCarsById = true;
    private boolean getCarsByName = true;
    ...
    private boolean getUsersById = true;
    private boolean getUsersByName = true;
}
